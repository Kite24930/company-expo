...
//            メール送信の処理
            ...
            DB::rollBack();
            return ['msg' => $e, 'request' => [$request->companyId, $request->studentNumber, $request->studentGrade, $request->studentDepartment, $request->studentName, $request->studentEmail, $request->title, $request->detail]];
        }
    }
}
