<x-template title="企業情報編集ページ">
    ...
    <form id="companyForm" method="POST" action="/api/company" class="container-md my-3">
        ...
        @if($count === 0)
            ...
            <x-company-input id="capital" name="資本金" type="tel" require="true">単位：百万円※数字のみ入力してください（例：資本金4000万円→40）</x-company-input>
            <x-company-input id="sales" name="売上高" type="tel" require="true">単位：百万円※数字のみ入力してください（例：売上高1億7000万円→170）</x-company-input>
            <x-company-input id="employees" name="従業員数" type="tel" require="true">単位：人※数字のみ入力してください</x-company-input>
            ...
            <x-company-input id="schoolmate" name="三重大学卒業生入社人数" type="tel" require="true">単位：人※数字のみ入力してください</x-company-input>
            <x-company-input id="recruitType" name="募集職種" type="text" require="true"></x-company-input>
            <x-company-input id="recruitPlannedNumber" name="採用予定人数" type="tel">単位：人※数字のみ入力してください</x-company-input>
        ...
        @else
            ...
            <x-company-input-edit id="capital" name="資本金" type="tel" require="true" :data="$data->capital">単位：百万円※数字のみ入力してください（例：資本金4000万円→40）</x-company-input-edit>
            <x-company-input-edit id="sales" name="売上高" type="tel" require="true" :data="$data->sales">単位：百万円※数字のみ入力してください（例：売上高1億7000万円→170）</x-company-input-edit>
            <x-company-input-edit id="employees" name="従業員数" type="tel" require="true" :data="$data->employees">単位：人※数字のみ入力してください</x-company-input-edit>
            ...
            <x-company-input-edit id="schoolmate" name="三重大学卒業生入社人数" type="tel" require="true" :data="$data->schoolmate">単位：人※数字のみ入力してください</x-company-input-edit>
            <x-company-input-edit id="recruitType" name="募集職種" type="text" require="true" :data="$data->recruit_type"></x-company-input-edit>
            <x-company-input-edit id="recruitPlannedNumber" name="採用予定人数" type="tel" :data="$data->recruit_planned_number">単位：人※数字のみ入力してください</x-company-input-edit>
